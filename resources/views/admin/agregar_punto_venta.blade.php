...
<head>
    ...
    <title>Agregar punto de venta - Gestor de Ventas Los Amates</title>
...
<body>
    ...
    <div class="encabezado">
        ...
        <p>Registrar una nueva caja y asignarla a un empleado</p>
    ...
    <div class="contenedor">
        ...
        <div class="tarjeta">
            ...
            <div class="titulo-formulario">
                ...
                <p>
                    Ingresa la información de la caja
                </p>
            ...
            <div class="informacion">
                ...
                El punto de venta será asignado al empleado seleccionado.
                El empleado podrá visualizar su punto de venta desde su dashboard.
            ...
            <form
                action="{{ route('admin.puntos_venta.store') }}"
                method="POST"
            >
