...
<head>
    ...
    <title>Editar información - Orquídeas y más Los Amates</title>
...
<body>
    ...
    <div class="encabezado">
        ...
        <a href="{{ route('cliente.informacion') }}" class="boton-regresar">
    ...
    <div class="contenedor">
        ...
        <div class="tarjeta">
            ...
            <form
                action="{{ route('cliente.informacion.actualizar') }}"
                method="POST"
                class="formulario"
            >
                ...
                <div class="acciones">
                    ...
                    <a
                        href="{{ route('cliente.informacion') }}"
